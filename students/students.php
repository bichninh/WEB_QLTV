      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM returned where student_id= '".$_SESSION['students']."'";
                $query = $conn->query($sql);
            ...
            <a href="viewreturned.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM borrow where student_id= '".$_SESSION['students']."' ";
                $query = $conn->query($sql);
            ...
            <a href="viewborrowed.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
           ...
           <h3> 1 </h3>
            ...
            <a href="viewprofide.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
<?php
  ...
  $borrow = array();
  for( $m = 1; $m <= 12; $m++ ) {
    $sql = "SELECT * FROM returned WHERE MONTH(date_return) = '$m' AND YEAR(date_return) = '$year'";
...
$(function(){
  $('#select_year').change(function(){
    window.location.href = 'students.php?year='+$(this).val();
  });
});
</script>
</body>

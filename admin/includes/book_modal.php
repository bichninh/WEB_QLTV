    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="author" class="col-sm-3 control-label">Quality</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">Quality</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_quality" name="quality">
                    </div>
                </div>
                <div class="form-group">

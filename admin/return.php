          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *FROM returned LEFT JOIN students ON students.id=returned.student_id LEFT JOIN books ON books.id=returned.book_id ORDER BY date_return DESC";
